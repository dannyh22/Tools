...
Join-AzStorageAccountForAuth -ResourceGroupName $ResourceGroupName -Name $StorageAccountName -DomainAccountType "<ComputerAccount|ServiceLogonAccount>"-OrganizationalUnitName "<ou-name-here>" 
