<#
# Create Users/Usergroups and OUs, 2018/3/28 Niall Brady, https://www.windows-noob.com
#
# This script:            Creates users/usergroups and ou's in AD
...
try {([ADSI]"WinNT://$computer/$Group,group").psbase.Invoke("Add",([ADSI]"WinNT://$domain/$YourUserName").path)}
